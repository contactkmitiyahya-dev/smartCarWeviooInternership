      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          case 0:
            ...
            _context.p = 1;
            _context.n = 2;
            return (0, _client.apiFetch)('/auth/me', {
              method: 'PATCH',
              body: JSON.stringify({
                name: formData.name,
          ...
          case 2:
            ...
            _context.n = 3;
            return (0, _client.apiFetch)('/auth/change-password', {
              method: 'POST',
              body: JSON.stringify({
          ...
          case 5:
            _context.p = 5;
            _t = _context.v;
            setError(_t instanceof _client.ApiError ? _t.message : 'Erreur lors de la mise à jour.');
          case 6:
            return _context.a(2);
        }
      }, _callee, null, [[1, 5]]);
