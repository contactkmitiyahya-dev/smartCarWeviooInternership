...
var _AuthLayout = _interopRequireDefault(require("../../components/auth/AuthLayout"));
var _SocialLoginButtons = _interopRequireDefault(require("../../components/auth/SocialLoginButtons"));
var _AuthContext = require("../../context/AuthContext");
var _client = require("../../api/client");
require("../../components/auth/authForm.css");
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          ...
          case 5:
            _context.p = 5;
            _t = _context.v;
            if (_t instanceof _client.ApiError) {
              setError(_t.message);
            } else {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_AuthLayout["default"], {
    ...
    children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_SocialLoginButtons["default"], {}), /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
      ...
      children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
        ...
        children: isSubmitting ? 'Création...' : 'Créer mon compte'
      })]
    })]
  });
}